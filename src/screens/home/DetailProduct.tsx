                ...
                <Box w="96%" ml="2%" h="auto" mt="-15%" p="2" bg="#ffffff" roundedTopRight="8" roundedTopLeft="8" roundedBottomRight="8" roundedBottomLeft="8" shadow={9}
                   borderWidth="1" borderColor="coolGray.300">
                    ...
                    <Flex direction="column" mt="1">
                      <Box mt="1" mb="2">
                        <Text style={styles.cardTitleDetail}>{`${detail.title}`}</Text>
                        <Text  style={styles.cardTitleDetail}>{`${detail.price}`}</Text>
                        <Text style={styles.titlePrice}>{`${detail.description}`}</Text>
                      </Box>
                    </Flex>
                      {/* </Flex> */}
                    </HStack>
