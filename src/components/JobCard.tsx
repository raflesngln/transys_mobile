        ...
        <Stack p="4" space={3}>
          <Stack space={2}>
            ...
            <HStack justifyContent="space-between">
              ...
              <Heading size="md" ml="-1">
                  <MenuActionLists pid= {shipment.mawb}/>
              </Heading>
            </HStack>
          ...
          <Stack>
            <Text fontWeight="700">{shipment.airlines}</Text>
          </Stack>
          <HStack justifyContent="space-between">
            <Text fontWeight="400">
              {shipment.shipper}
          ...
          <Stack>
            <Text>{shipment.remark}</Text>
          </Stack>
          <Stack><Text  >Attachment :</Text></Stack>
          <HStack space="2" justifyContent="flex-start">
              <Gambar source={shipment.image_1}/>
              <Gambar source={shipment.image_2}/>
              <Gambar source={shipment.image_3}/>
          </HStack>
...
const Gambar=(props:any)=>{
  return(
    <Box h="33%">
      {
        props.source &&       
        <>
        <AspectRatio w="33%" h="60" ratio={16 / 9}>
          <Image source={{
            uri: props.source
          }} alt="image" borderRadius={6} />
        </AspectRatio>
        </>
      }
  </Box>
